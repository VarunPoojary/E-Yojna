...
class StudentSchemesPage extends StatefulWidget {
  const StudentSchemesPage({Key? key}) : super(key: key);

  @override
  State<StudentSchemesPage> createState() => StudentSchemesPageState();
}

class StudentSchemesPageState extends State<StudentSchemesPage> {
                            ...
                            child: Column(
                              children: [
                                Padding(
                                  padding: const EdgeInsets.only(top: 10, right: 90),
                                  child: SizedBox(
                                    child: Image.asset('assets/images/scheme6.png'),
                                    height: 45,
                                    width: 45,
                                  ),
                                ),
